...
public class RegolaOrariaResourceIT {
    ...
    private static final OreEnum DEFAULT_ORA_INIZIO = OreEnum.SETTE;
    private static final OreEnum UPDATED_ORA_INIZIO = OreEnum.OTTO;

    private static final MinutiEnum DEFAULT_MINUTI_INIZIO = MinutiEnum.ZERO;
    private static final MinutiEnum UPDATED_MINUTI_INIZIO = MinutiEnum.QUINDICI;

    private static final OreEnum DEFAULT_ORA_FINE = OreEnum.SETTE;
    private static final OreEnum UPDATED_ORA_FINE = OreEnum.OTTO;

    private static final MinutiEnum DEFAULT_MINUTI_FINE = MinutiEnum.ZERO;
    private static final MinutiEnum UPDATED_MINUTI_FINE = MinutiEnum.QUINDICI;
