...
public class PermessoTemporaneoResourceIT {
    ...
    private static final String DEFAULT_PROTOCOLLO_ENTRATA = "AAAAAAAAAA";
    private static final String UPDATED_PROTOCOLLO_ENTRATA = "BBBBBBBBBB";

    private static final String DEFAULT_PROTOCOLLO_USCITA = "AAAAAAAAAA";
    private static final String UPDATED_PROTOCOLLO_USCITA = "BBBBBBBBBB";
    ...
    public static PermessoTemporaneo createEntity(EntityManager em) {
        PermessoTemporaneo permessoTemporaneo = new PermessoTemporaneo()
            ...
            .protocolloEntrata(DEFAULT_PROTOCOLLO_ENTRATA)
            .protocolloUscita(DEFAULT_PROTOCOLLO_USCITA);
    ...
    public static PermessoTemporaneo createUpdatedEntity(EntityManager em) {
        PermessoTemporaneo permessoTemporaneo = new PermessoTemporaneo()
            ...
            .protocolloEntrata(UPDATED_PROTOCOLLO_ENTRATA)
            .protocolloUscita(UPDATED_PROTOCOLLO_USCITA);
        return permessoTemporaneo;
    }
    ...
    public void createPermessoTemporaneo() throws Exception {
        ...
        assertThat(testPermessoTemporaneo.getProtocolloEntrata()).isEqualTo(DEFAULT_PROTOCOLLO_ENTRATA);
        assertThat(testPermessoTemporaneo.getProtocolloUscita()).isEqualTo(DEFAULT_PROTOCOLLO_USCITA);
    }
    ...
    public void getAllPermessoTemporaneos() throws Exception {
        ...
        restPermessoTemporaneoMockMvc
            ...
            .andExpect(jsonPath("$.[*].protocolloEntrata").value(hasItem(DEFAULT_PROTOCOLLO_ENTRATA)))
            .andExpect(jsonPath("$.[*].protocolloUscita").value(hasItem(DEFAULT_PROTOCOLLO_USCITA)));
    }
    ...
    public void getPermessoTemporaneo() throws Exception {
        ...
        restPermessoTemporaneoMockMvc
            ...
            .andExpect(jsonPath("$.protocolloEntrata").value(DEFAULT_PROTOCOLLO_ENTRATA))
            .andExpect(jsonPath("$.protocolloUscita").value(DEFAULT_PROTOCOLLO_USCITA));
    }
    ...
    @Test
    @Transactional
    public void getAllPermessoTemporaneosByProtocolloEntrataIsEqualToSomething() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where protocolloEntrata equals to DEFAULT_PROTOCOLLO_ENTRATA
        defaultPermessoTemporaneoShouldBeFound("protocolloEntrata.equals=" + DEFAULT_PROTOCOLLO_ENTRATA);

        // Get all the permessoTemporaneoList where protocolloEntrata equals to UPDATED_PROTOCOLLO_ENTRATA
        defaultPermessoTemporaneoShouldNotBeFound("protocolloEntrata.equals=" + UPDATED_PROTOCOLLO_ENTRATA);
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByProtocolloEntrataIsNotEqualToSomething() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where protocolloEntrata not equals to DEFAULT_PROTOCOLLO_ENTRATA
        defaultPermessoTemporaneoShouldNotBeFound("protocolloEntrata.notEquals=" + DEFAULT_PROTOCOLLO_ENTRATA);

        // Get all the permessoTemporaneoList where protocolloEntrata not equals to UPDATED_PROTOCOLLO_ENTRATA
        defaultPermessoTemporaneoShouldBeFound("protocolloEntrata.notEquals=" + UPDATED_PROTOCOLLO_ENTRATA);
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByProtocolloEntrataIsInShouldWork() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where protocolloEntrata in DEFAULT_PROTOCOLLO_ENTRATA or UPDATED_PROTOCOLLO_ENTRATA
        defaultPermessoTemporaneoShouldBeFound("protocolloEntrata.in=" + DEFAULT_PROTOCOLLO_ENTRATA + "," + UPDATED_PROTOCOLLO_ENTRATA);

        // Get all the permessoTemporaneoList where protocolloEntrata equals to UPDATED_PROTOCOLLO_ENTRATA
        defaultPermessoTemporaneoShouldNotBeFound("protocolloEntrata.in=" + UPDATED_PROTOCOLLO_ENTRATA);
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByProtocolloEntrataIsNullOrNotNull() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where protocolloEntrata is not null
        defaultPermessoTemporaneoShouldBeFound("protocolloEntrata.specified=true");

        // Get all the permessoTemporaneoList where protocolloEntrata is null
        defaultPermessoTemporaneoShouldNotBeFound("protocolloEntrata.specified=false");
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByProtocolloEntrataContainsSomething() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where protocolloEntrata contains DEFAULT_PROTOCOLLO_ENTRATA
        defaultPermessoTemporaneoShouldBeFound("protocolloEntrata.contains=" + DEFAULT_PROTOCOLLO_ENTRATA);

        // Get all the permessoTemporaneoList where protocolloEntrata contains UPDATED_PROTOCOLLO_ENTRATA
        defaultPermessoTemporaneoShouldNotBeFound("protocolloEntrata.contains=" + UPDATED_PROTOCOLLO_ENTRATA);
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByProtocolloEntrataNotContainsSomething() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where protocolloEntrata does not contain DEFAULT_PROTOCOLLO_ENTRATA
        defaultPermessoTemporaneoShouldNotBeFound("protocolloEntrata.doesNotContain=" + DEFAULT_PROTOCOLLO_ENTRATA);

        // Get all the permessoTemporaneoList where protocolloEntrata does not contain UPDATED_PROTOCOLLO_ENTRATA
        defaultPermessoTemporaneoShouldBeFound("protocolloEntrata.doesNotContain=" + UPDATED_PROTOCOLLO_ENTRATA);
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByProtocolloUscitaIsEqualToSomething() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where protocolloUscita equals to DEFAULT_PROTOCOLLO_USCITA
        defaultPermessoTemporaneoShouldBeFound("protocolloUscita.equals=" + DEFAULT_PROTOCOLLO_USCITA);

        // Get all the permessoTemporaneoList where protocolloUscita equals to UPDATED_PROTOCOLLO_USCITA
        defaultPermessoTemporaneoShouldNotBeFound("protocolloUscita.equals=" + UPDATED_PROTOCOLLO_USCITA);
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByProtocolloUscitaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where protocolloUscita not equals to DEFAULT_PROTOCOLLO_USCITA
        defaultPermessoTemporaneoShouldNotBeFound("protocolloUscita.notEquals=" + DEFAULT_PROTOCOLLO_USCITA);

        // Get all the permessoTemporaneoList where protocolloUscita not equals to UPDATED_PROTOCOLLO_USCITA
        defaultPermessoTemporaneoShouldBeFound("protocolloUscita.notEquals=" + UPDATED_PROTOCOLLO_USCITA);
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByProtocolloUscitaIsInShouldWork() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where protocolloUscita in DEFAULT_PROTOCOLLO_USCITA or UPDATED_PROTOCOLLO_USCITA
        defaultPermessoTemporaneoShouldBeFound("protocolloUscita.in=" + DEFAULT_PROTOCOLLO_USCITA + "," + UPDATED_PROTOCOLLO_USCITA);

        // Get all the permessoTemporaneoList where protocolloUscita equals to UPDATED_PROTOCOLLO_USCITA
        defaultPermessoTemporaneoShouldNotBeFound("protocolloUscita.in=" + UPDATED_PROTOCOLLO_USCITA);
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByProtocolloUscitaIsNullOrNotNull() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where protocolloUscita is not null
        defaultPermessoTemporaneoShouldBeFound("protocolloUscita.specified=true");

        // Get all the permessoTemporaneoList where protocolloUscita is null
        defaultPermessoTemporaneoShouldNotBeFound("protocolloUscita.specified=false");
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByProtocolloUscitaContainsSomething() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where protocolloUscita contains DEFAULT_PROTOCOLLO_USCITA
        defaultPermessoTemporaneoShouldBeFound("protocolloUscita.contains=" + DEFAULT_PROTOCOLLO_USCITA);

        // Get all the permessoTemporaneoList where protocolloUscita contains UPDATED_PROTOCOLLO_USCITA
        defaultPermessoTemporaneoShouldNotBeFound("protocolloUscita.contains=" + UPDATED_PROTOCOLLO_USCITA);
    }

    @Test
    @Transactional
    public void getAllPermessoTemporaneosByProtocolloUscitaNotContainsSomething() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);

        // Get all the permessoTemporaneoList where protocolloUscita does not contain DEFAULT_PROTOCOLLO_USCITA
        defaultPermessoTemporaneoShouldNotBeFound("protocolloUscita.doesNotContain=" + DEFAULT_PROTOCOLLO_USCITA);

        // Get all the permessoTemporaneoList where protocolloUscita does not contain UPDATED_PROTOCOLLO_USCITA
        defaultPermessoTemporaneoShouldBeFound("protocolloUscita.doesNotContain=" + UPDATED_PROTOCOLLO_USCITA);
    }
    ...
    @Test
    @Transactional
    public void getAllPermessoTemporaneosByTipogiaVeicoloIsEqualToSomething() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);
        TipologiaVeicolo tipogiaVeicolo = TipologiaVeicoloResourceIT.createEntity(em);
        em.persist(tipogiaVeicolo);
        em.flush();
        permessoTemporaneo.setTipogiaVeicolo(tipogiaVeicolo);
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);
        Long tipogiaVeicoloId = tipogiaVeicolo.getId();

        // Get all the permessoTemporaneoList where tipogiaVeicolo equals to tipogiaVeicoloId
        defaultPermessoTemporaneoShouldBeFound("tipogiaVeicoloId.equals=" + tipogiaVeicoloId);

        // Get all the permessoTemporaneoList where tipogiaVeicolo equals to tipogiaVeicoloId + 1
        defaultPermessoTemporaneoShouldNotBeFound("tipogiaVeicoloId.equals=" + (tipogiaVeicoloId + 1));
    }
    ...
    @Test
    @Transactional
    public void getAllPermessoTemporaneosByZonaIsEqualToSomething() throws Exception {
        // Initialize the database
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);
        Zona zona = ZonaResourceIT.createEntity(em);
        em.persist(zona);
        em.flush();
        permessoTemporaneo.setZona(zona);
        permessoTemporaneoRepository.saveAndFlush(permessoTemporaneo);
        Long zonaId = zona.getId();

        // Get all the permessoTemporaneoList where zona equals to zonaId
        defaultPermessoTemporaneoShouldBeFound("zonaId.equals=" + zonaId);

        // Get all the permessoTemporaneoList where zona equals to zonaId + 1
        defaultPermessoTemporaneoShouldNotBeFound("zonaId.equals=" + (zonaId + 1));
    }
    ...
    public void updatePermessoTemporaneo() throws Exception {
        ...
        assertThat(testPermessoTemporaneo.getProtocolloEntrata()).isEqualTo(UPDATED_PROTOCOLLO_ENTRATA);
        assertThat(testPermessoTemporaneo.getProtocolloUscita()).isEqualTo(UPDATED_PROTOCOLLO_USCITA);
    }
