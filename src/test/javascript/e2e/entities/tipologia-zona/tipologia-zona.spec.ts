...
describe('TipologiaZona e2e test', () => {
  ...
  it('should load TipologiaZonas', async () => {
    ...
    expect(await tipologiaZonaComponentsPage.getTitle()).to.eq('myZtl4App.tipologiaZona.home.title');
    await browser.wait(
  ...
  it('should load create TipologiaZona page', async () => {
    ...
    expect(await tipologiaZonaUpdatePage.getPageTitle()).to.eq('myZtl4App.tipologiaZona.home.createOrEditLabel');
  ...
  it('should delete last TipologiaZona', async () => {
    ...
    expect(await tipologiaZonaDeleteDialog.getDialogTitle()).to.eq('myZtl4App.tipologiaZona.delete.question');
