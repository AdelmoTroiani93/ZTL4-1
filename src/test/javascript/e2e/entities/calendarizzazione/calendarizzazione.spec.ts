...
describe('Calendarizzazione e2e test', () => {
  ...
  it('should load Calendarizzaziones', async () => {
    ...
    expect(await calendarizzazioneComponentsPage.getTitle()).to.eq('myZtl4App.calendarizzazione.home.title');
    await browser.wait(
  ...
  it('should load create Calendarizzazione page', async () => {
    ...
    expect(await calendarizzazioneUpdatePage.getPageTitle()).to.eq('myZtl4App.calendarizzazione.home.createOrEditLabel');
  ...
  it('should delete last Calendarizzazione', async () => {
    ...
    expect(await calendarizzazioneDeleteDialog.getDialogTitle()).to.eq('myZtl4App.calendarizzazione.delete.question');
