...
describe('Motivazione e2e test', () => {
  ...
  it('should load Motivaziones', async () => {
    ...
    expect(await motivazioneComponentsPage.getTitle()).to.eq('myZtl4App.motivazione.home.title');
    await browser.wait(
  ...
  it('should load create Motivazione page', async () => {
    ...
    expect(await motivazioneUpdatePage.getPageTitle()).to.eq('myZtl4App.motivazione.home.createOrEditLabel');
  ...
  it('should delete last Motivazione', async () => {
    ...
    expect(await motivazioneDeleteDialog.getDialogTitle()).to.eq('myZtl4App.motivazione.delete.question');
