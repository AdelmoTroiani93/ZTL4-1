...
describe('TipologiaPermesso e2e test', () => {
  ...
  it('should load TipologiaPermessos', async () => {
    ...
    expect(await tipologiaPermessoComponentsPage.getTitle()).to.eq('myZtl4App.tipologiaPermesso.home.title');
    await browser.wait(
  ...
  it('should load create TipologiaPermesso page', async () => {
    ...
    expect(await tipologiaPermessoUpdatePage.getPageTitle()).to.eq('myZtl4App.tipologiaPermesso.home.createOrEditLabel');
  ...
  it('should delete last TipologiaPermesso', async () => {
    ...
    expect(await tipologiaPermessoDeleteDialog.getDialogTitle()).to.eq('myZtl4App.tipologiaPermesso.delete.question');
