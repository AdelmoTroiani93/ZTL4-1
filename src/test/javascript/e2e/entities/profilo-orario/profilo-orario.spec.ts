...
describe('ProfiloOrario e2e test', () => {
  ...
  it('should load ProfiloOrarios', async () => {
    ...
    expect(await profiloOrarioComponentsPage.getTitle()).to.eq('myZtl4App.profiloOrario.home.title');
    await browser.wait(
  ...
  it('should load create ProfiloOrario page', async () => {
    ...
    expect(await profiloOrarioUpdatePage.getPageTitle()).to.eq('myZtl4App.profiloOrario.home.createOrEditLabel');
  ...
  it('should delete last ProfiloOrario', async () => {
    ...
    expect(await profiloOrarioDeleteDialog.getDialogTitle()).to.eq('myZtl4App.profiloOrario.delete.question');
