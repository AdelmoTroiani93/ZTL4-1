...
describe('PermessoTemporaneo e2e test', () => {
  ...
  it('should load PermessoTemporaneos', async () => {
    ...
    expect(await permessoTemporaneoComponentsPage.getTitle()).to.eq('myZtl4App.permessoTemporaneo.home.title');
    await browser.wait(
  ...
  it('should load create PermessoTemporaneo page', async () => {
    ...
    expect(await permessoTemporaneoUpdatePage.getPageTitle()).to.eq('myZtl4App.permessoTemporaneo.home.createOrEditLabel');
  ...
  it('should create and save PermessoTemporaneos', async () => {
    ...
    await promise.all([
      ...
      permessoTemporaneoUpdatePage.setProtocolloEntrataInput('protocolloEntrata'),
      permessoTemporaneoUpdatePage.setProtocolloUscitaInput('protocolloUscita'),
      permessoTemporaneoUpdatePage.calendarioSelectLastOption(),
      permessoTemporaneoUpdatePage.tipoPermessoSelectLastOption(),
      permessoTemporaneoUpdatePage.tipogiaVeicoloSelectLastOption(),
      permessoTemporaneoUpdatePage.durataSelectLastOption(),
      permessoTemporaneoUpdatePage.zonaSelectLastOption(),
    ...
    expect(await permessoTemporaneoUpdatePage.getProtocolloEntrataInput()).to.eq(
      'protocolloEntrata',
      'Expected ProtocolloEntrata value to be equals to protocolloEntrata'
    );
    expect(await permessoTemporaneoUpdatePage.getProtocolloUscitaInput()).to.eq(
      'protocolloUscita',
      'Expected ProtocolloUscita value to be equals to protocolloUscita'
    );
  ...
  it('should delete last PermessoTemporaneo', async () => {
    ...
    expect(await permessoTemporaneoDeleteDialog.getDialogTitle()).to.eq('myZtl4App.permessoTemporaneo.delete.question');
