...
export class PermessoTemporaneoUpdatePage {
  ...
  protocolloEntrataInput = element(by.id('field_protocolloEntrata'));
  protocolloUscitaInput = element(by.id('field_protocolloUscita'));

  calendarioSelect = element(by.id('field_calendario'));
  tipoPermessoSelect = element(by.id('field_tipoPermesso'));
  tipogiaVeicoloSelect = element(by.id('field_tipogiaVeicolo'));
  durataSelect = element(by.id('field_durata'));
  zonaSelect = element(by.id('field_zona'));
  ...
  async setProtocolloEntrataInput(protocolloEntrata: string): Promise<void> {
    await this.protocolloEntrataInput.sendKeys(protocolloEntrata);
  }

  async getProtocolloEntrataInput(): Promise<string> {
    return await this.protocolloEntrataInput.getAttribute('value');
  }

  async setProtocolloUscitaInput(protocolloUscita: string): Promise<void> {
    await this.protocolloUscitaInput.sendKeys(protocolloUscita);
  }

  async getProtocolloUscitaInput(): Promise<string> {
    return await this.protocolloUscitaInput.getAttribute('value');
  }
  ...
  async tipogiaVeicoloSelectLastOption(): Promise<void> {
    await this.tipogiaVeicoloSelect.all(by.tagName('option')).last().click();
  }

  async tipogiaVeicoloSelectOption(option: string): Promise<void> {
    await this.tipogiaVeicoloSelect.sendKeys(option);
  }

  getTipogiaVeicoloSelect(): ElementFinder {
    return this.tipogiaVeicoloSelect;
  }

  async getTipogiaVeicoloSelectedOption(): Promise<string> {
    return await this.tipogiaVeicoloSelect.element(by.css('option:checked')).getText();
  }
  ...
  async zonaSelectLastOption(): Promise<void> {
    await this.zonaSelect.all(by.tagName('option')).last().click();
  }

  async zonaSelectOption(option: string): Promise<void> {
    await this.zonaSelect.sendKeys(option);
  }

  getZonaSelect(): ElementFinder {
    return this.zonaSelect;
  }

  async getZonaSelectedOption(): Promise<string> {
    return await this.zonaSelect.element(by.css('option:checked')).getText();
  }
