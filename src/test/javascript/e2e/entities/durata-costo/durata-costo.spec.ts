...
describe('DurataCosto e2e test', () => {
  ...
  it('should load DurataCostos', async () => {
    ...
    expect(await durataCostoComponentsPage.getTitle()).to.eq('myZtl4App.durataCosto.home.title');
    await browser.wait(
  ...
  it('should load create DurataCosto page', async () => {
    ...
    expect(await durataCostoUpdatePage.getPageTitle()).to.eq('myZtl4App.durataCosto.home.createOrEditLabel');
  ...
  it('should delete last DurataCosto', async () => {
    ...
    expect(await durataCostoDeleteDialog.getDialogTitle()).to.eq('myZtl4App.durataCosto.delete.question');
