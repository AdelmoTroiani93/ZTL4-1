...
describe('Festivita e2e test', () => {
  ...
  it('should load Festivitas', async () => {
    ...
    expect(await festivitaComponentsPage.getTitle()).to.eq('myZtl4App.festivita.home.title');
  ...
  it('should load create Festivita page', async () => {
    ...
    expect(await festivitaUpdatePage.getPageTitle()).to.eq('myZtl4App.festivita.home.createOrEditLabel');
  ...
  it('should delete last Festivita', async () => {
    ...
    expect(await festivitaDeleteDialog.getDialogTitle()).to.eq('myZtl4App.festivita.delete.question');
