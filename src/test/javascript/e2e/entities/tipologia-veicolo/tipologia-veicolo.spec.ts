...
describe('TipologiaVeicolo e2e test', () => {
  ...
  it('should load TipologiaVeicolos', async () => {
    ...
    expect(await tipologiaVeicoloComponentsPage.getTitle()).to.eq('myZtl4App.tipologiaVeicolo.home.title');
    await browser.wait(
  ...
  it('should load create TipologiaVeicolo page', async () => {
    ...
    expect(await tipologiaVeicoloUpdatePage.getPageTitle()).to.eq('myZtl4App.tipologiaVeicolo.home.createOrEditLabel');
  ...
  it('should delete last TipologiaVeicolo', async () => {
    ...
    expect(await tipologiaVeicoloDeleteDialog.getDialogTitle()).to.eq('myZtl4App.tipologiaVeicolo.delete.question');
