...
describe('GruppoVarchi e2e test', () => {
  ...
  it('should load GruppoVarchis', async () => {
    ...
    expect(await gruppoVarchiComponentsPage.getTitle()).to.eq('myZtl4App.gruppoVarchi.home.title');
    await browser.wait(
  ...
  it('should load create GruppoVarchi page', async () => {
    ...
    expect(await gruppoVarchiUpdatePage.getPageTitle()).to.eq('myZtl4App.gruppoVarchi.home.createOrEditLabel');
  ...
  it('should delete last GruppoVarchi', async () => {
    ...
    expect(await gruppoVarchiDeleteDialog.getDialogTitle()).to.eq('myZtl4App.gruppoVarchi.delete.question');
