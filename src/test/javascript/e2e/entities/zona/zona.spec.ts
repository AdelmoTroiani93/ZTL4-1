...
describe('Zona e2e test', () => {
  ...
  it('should load Zonas', async () => {
    ...
    expect(await zonaComponentsPage.getTitle()).to.eq('myZtl4App.zona.home.title');
  ...
  it('should load create Zona page', async () => {
    ...
    expect(await zonaUpdatePage.getPageTitle()).to.eq('myZtl4App.zona.home.createOrEditLabel');
  ...
  it('should delete last Zona', async () => {
    ...
    expect(await zonaDeleteDialog.getDialogTitle()).to.eq('myZtl4App.zona.delete.question');
