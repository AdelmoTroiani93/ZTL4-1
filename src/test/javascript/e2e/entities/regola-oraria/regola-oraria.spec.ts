...
describe('RegolaOraria e2e test', () => {
  ...
  it('should load RegolaOrarias', async () => {
    ...
    expect(await regolaOrariaComponentsPage.getTitle()).to.eq('myZtl4App.regolaOraria.home.title');
    await browser.wait(
  ...
  it('should load create RegolaOraria page', async () => {
    ...
    expect(await regolaOrariaUpdatePage.getPageTitle()).to.eq('myZtl4App.regolaOraria.home.createOrEditLabel');
  ...
  it('should delete last RegolaOraria', async () => {
    ...
    expect(await regolaOrariaDeleteDialog.getDialogTitle()).to.eq('myZtl4App.regolaOraria.delete.question');
