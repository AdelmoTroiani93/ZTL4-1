...
describe('Varco e2e test', () => {
  ...
  it('should load Varcos', async () => {
    ...
    expect(await varcoComponentsPage.getTitle()).to.eq('myZtl4App.varco.home.title');
  ...
  it('should load create Varco page', async () => {
    ...
    expect(await varcoUpdatePage.getPageTitle()).to.eq('myZtl4App.varco.home.createOrEditLabel');
  ...
  it('should delete last Varco', async () => {
    ...
    expect(await varcoDeleteDialog.getDialogTitle()).to.eq('myZtl4App.varco.delete.question');
