...
describe('Autorizzazione e2e test', () => {
  ...
  it('should load Autorizzaziones', async () => {
    ...
    expect(await autorizzazioneComponentsPage.getTitle()).to.eq('myZtl4App.autorizzazione.home.title');
    await browser.wait(
  ...
  it('should load create Autorizzazione page', async () => {
    ...
    expect(await autorizzazioneUpdatePage.getPageTitle()).to.eq('myZtl4App.autorizzazione.home.createOrEditLabel');
  ...
  it('should delete last Autorizzazione', async () => {
    ...
    expect(await autorizzazioneDeleteDialog.getDialogTitle()).to.eq('myZtl4App.autorizzazione.delete.question');
