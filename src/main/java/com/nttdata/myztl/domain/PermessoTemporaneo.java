...
public class PermessoTemporaneo implements Serializable {
    ...
    @Column(name = "protocollo_entrata")
    private String protocolloEntrata;

    @Column(name = "protocollo_uscita")
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = "permessoTemporaneos", allowSetters = true)
    private TipologiaVeicolo tipogiaVeicolo;
    ...
    public String getProtocolloEntrata() {
        return protocolloEntrata;
    }

    public PermessoTemporaneo protocolloEntrata(String protocolloEntrata) {
        this.protocolloEntrata = protocolloEntrata;
        return this;
    }

    public void setProtocolloEntrata(String protocolloEntrata) {
        this.protocolloEntrata = protocolloEntrata;
    }
    ...
    public PermessoTemporaneo protocolloUscita(String protocolloUscita) {
    ...
    public TipologiaVeicolo getTipogiaVeicolo() {
        return tipogiaVeicolo;
    }

    public PermessoTemporaneo tipogiaVeicolo(TipologiaVeicolo tipologiaVeicolo) {
        this.tipogiaVeicolo = tipologiaVeicolo;
        return this;
    }

    public void setTipogiaVeicolo(TipologiaVeicolo tipologiaVeicolo) {
        this.tipogiaVeicolo = tipologiaVeicolo;
    }
    ...
    public PermessoTemporaneo zona(Zona zona) {
        this.zona = zona;
        return this;
    }
    ...
    public String toString() {
        return "PermessoTemporaneo{" +
            ...
            ", pagato='" + isPagato() + "'" +
            ", protocolloEntrata='" + getProtocolloEntrata() + "'" +
            ", protocolloUscita='" + getProtocolloUscita() + "'" +
            "}";
    }
}
